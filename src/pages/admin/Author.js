...
import { getAuthor, deleteAuthor } from "../../redux/action/author";
...
class Author extends Component {
  ...
  fetchData = async (params) => {
    ...
    this.props.getAuthor(param).then((response) => {
      console.log("store: ", this.props.author);
      console.log("response: ", response);

      this.setState({ isLoading: false, dataAuthor: response.value.data.data });
      if (param) {
    ...
    return (
      <>
                          ...
                          {dataAuthor.map((author, index) => (
                            <tr key={author.id.toString()}>
                              ...
                              <td align="center">
                                ...
                                <Button
                                  onClick={() => {
                                    this.onDelete(author.id);
                                  }}
                                  className="btn btn-danger ml-2 mt-2 align-items-center"
                                >
                                  Delete
                                </Button>
        ...
        <Modal isOpen={this.state.showEditModal}>
          ...
          <ModalFooter>
            <Button color="primary" onClick={this.handlerUpdate}>
              Edit
            </Button>

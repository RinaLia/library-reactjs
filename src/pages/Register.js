...
class Register extends Component {
  ...
  handleRegist = async (event) => {
    ...
    console.log(url)
    if (this.state.username.length<3 || this.state.email.length<3 || this.state.password.length<3) {
      swal.fire({
        icon: 'error',
        title: 'Oops!',
                ...
                <Form onSubmit={this.handleRegist}>
                  ...
                  <FormGroup>
                    <Label className='w-100'>
                      <div>Username</div>
                      <Input name='username' bsSize='sm' placeholder='Name' onChange={this.handleChange} />
                    </Label>
                  </FormGroup>
                  <FormGroup>
                    <Label className='w-100'>
                      <div>Email</div>
                      <Input name='email' bsSize='sm' placeholder='name@gmail.com' onChange={this.handleChange} />
                    </Label>
                  </FormGroup>
                  <FormGroup>
                    <Label className='w-100'>
